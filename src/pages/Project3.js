        ...
        <>  
            ...
            >
                ...
                <Container align="center" sx={{ m: "1rem" }}>
                    <Link href="https://sensational-blancmange-3f973b.netlify.app/" underline="none" m={2} target="_blank">
                        <Button variant="contained" size="small">Launch App</Button>
                    </Link>
                    <Link href="https://github.com/luisv7/ecom-dash-frontend" underline="none" target="_blank">
                        <Button variant="contained" size="small" sx={{ bgcolor: "#000", ':hover': {bgcolor: "white", color: "black"}}} endIcon={<GitHubIcon />}>View on</Button>
                    </Link>
                </Container>
            </Container>
            <img className="img-banner" src="https://i.ibb.co/z2dDDc6/Screen-Shot-2022-10-17-at-11-32-21-PM.png" alt="Lyrics Finder" />
            <Container maxWidth="sm" sx={{ display: "flex", justifyContent: "center", flexDirection: "column" }} >
                ...
                <Stack spacing={1} alignItems="center" sx={{ m: "1rem 0"}}>
                    <Stack direction="row" spacing={1} sx={{ display: "flex", flexWrap: "wrap", gap: "0.7rem"}}>
                        ...
                        <Chip label="React.js" color="primary" icon={<DoneIcon/>} />
                        ...
                        <Chip label="Google Firebase" color="primary" icon={<DoneIcon/>} />
                    </Stack>
                </Stack>
            </Container>
            <Container
                ...
                >
                    ...
                    <Typography component="p" variant="subtitle1" align="center" mt={2}>
                        With Ecom Dash you can build an e-commerce website in minutes. Simply add your product information, image URL, and you have a clean yet simple catalog/store. New updates coming soon to this project.
                    </Typography>
            </Container>
        </>
    )   
